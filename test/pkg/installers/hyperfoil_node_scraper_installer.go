...
const (
	...
	// NodeScraperStartConfigMapName ConfigMap name for start stript of Node scraper
	NodeScraperStartConfigMapName = "node-scraper-start"
	// NodeScraperStopConfigMapName ConfigMap name for stop stript of Node scraper
